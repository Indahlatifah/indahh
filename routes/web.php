...
Route::middleware(['auth', 'user-access:superadmin'])->group(function () 
{
    ...
    Route::post('superadmin/create_user', [DashboardController::class, 'Supercreate_user'])->name('superadmin.create_user');
});
...
Route::post('/laporan/simpan_pengaduan', [LaporanController::class, 'store']);
/*Logout*/
